...
if __name__ == '__main__':
    ...
    user1 = SocialMediaUser('Luis', 'Delrey Beach')
    user2 = SocialMediaUser('Lourdes', 'Delrey Beach', 200)
    user3 = SocialMediaUser('Santiago', 'Tamarac', upvotes=1000)
    user4 = SocialMediaUser('Dennis', 'Boca Raton', upvotes=2000)
    print('name: {}, is popular: {}, num upvotes: {}'.format(user4.name, user4.is_popular(), user4.upvotes))
    print('name: {}, is popular: {}, num upvotes: {}'.format(user3.name, user3.is_popular(), user4.upvotes))
